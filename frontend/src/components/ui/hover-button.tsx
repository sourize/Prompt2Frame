    ...
    ({ className, children, ...props }, ref) => {
        ...
        return (
            <button
                ref={buttonRef}
                className={cn(
                    "relative isolate px-6 py-2.5 sm:px-8 sm:py-3 rounded-3xl", // Mobile optimized padding
                    "text-white font-medium text-sm sm:text-base leading-6", // Explicit white text
                    "backdrop-blur-lg bg-white/10 border border-white/10", // More visible background/border
                    "cursor-pointer overflow-hidden transition-all active:scale-95 hover:bg-white/15", // Hover state
