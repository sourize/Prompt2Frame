...
export function Footer({
    ...
    return (
        <footer className="pb-6 pt-16 lg:pb-8 lg:pt-24 bg-black/40 backdrop-blur-md border-t border-white/5">
                        ...
                        {socialLinks.map((link, i) => (
                            <li key={i}>
                                <Button
                                    variant="secondary"
                                    size="icon"
                                    className="h-10 w-10 rounded-full bg-white/5 hover:bg-white/10 text-white border border-white/10"
                                    asChild
                                >
