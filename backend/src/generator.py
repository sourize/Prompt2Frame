...
SYSTEM_PROMPT = (
    ...
    "IMPORTANT: Your response must be ONLY the Python code, starting with these imports:\n"
    "from manim import *\n"
    ...
    "Your response must be ONLY the Python code, starting with the required imports. "
    "The code must be a complete, valid Manim Scene class that can be executed directly. "
