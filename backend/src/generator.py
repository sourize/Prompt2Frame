...
SYSTEM = (
    ...
    "\n"
    "INPUT:\n"
    "- Valid JSON with `intent_graph` and `animation_blueprint`.\n"
    "\n"
    "OUTPUT:\n"
    ...
    "====================================================\n"
    "\n"
    "🚨 YOU MAY CALL `self.play()` AT MOST **ONCE** IN THE ENTIRE SCENE.\n"
    "\n"
    "- One `self.play(...)` = one render pass.\n"
    "- More than one `self.play(...)` = INVALID OUTPUT.\n"
    "- The executor WILL reject fragmented renders.\n"
    "\n"
