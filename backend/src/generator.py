...
MASTER_SYSTEM_PROMPT = (
    ...
    "  Triangle()  # Equilateral triangle (no side_length param)\n"
    "  RegularPolygon(n=3, side_length=2, color=YELLOW)  # Triangle with size\n"
    "  Polygon(*vertices, color=ORANGE)  # Custom polygon\n"
    "  RegularPolygon(n=6, side_length=1, color=BLUE)  # Hexagon\n"
