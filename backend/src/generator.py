...
SYSTEM = (
    ...
    "    def construct(self):\n"
    "\n"
    "        # 1. READ auto_scaling from JSON\n"
    "        #    Extract: default_size, text_size, spacing\n"
    "        # 2. OBJECT CREATION (NO ANIMATION)\n"
    "        #    Apply default_size from auto_scaling\n"
    "        # 3. ANIMATION CONSTRUCTION (NO self.play yet)\n"
    "        # 4. SINGLE self.play(AnimationGroup / Succession)\n"
    "        # 5. self.wait(1)\n"
    "\n"
    "====================================================\n"
    "AUTO-SCALING RULES (CRITICAL)\n"
    "====================================================\n"
    "\n"
    ...
    "====================================================\n"
    "\n"
    "✔ EXACTLY ONE self.play(...) call is allowed.\n"
    "✔ All animations MUST be composed using:\n"
    "   - AnimationGroup\n"
    "   - Succession\n"
    "\n"
    "❌ Multiple self.play calls are forbidden.\n"
    "❌ Implicit waits are forbidden.\n"
    "\n"
    "====================================================\n"
    "INTENT → MANIM MAPPING TABLE (FIXED)\n"
    "====================================================\n"
    "\n"
    "create       → Create(mobject)\n"
    "write        → Write(text)\n"
    "transform    → ReplacementTransform(a, b)\n"
    ...
    "If intent is \"bounce\":\n"
    "- Use MoveAlongPath\n"
    "- Use a sinusoidal FunctionGraph\n"
    "- NEVER use Bounce()\n"
    "\n"
    "====================================================\n"
    "PATH SAFETY RULES\n"
    ...
    "- Prefer static → motion → transform\n"
